...
const ChatInput = () => {
  return (
    <div className="sticky bottom-0 flex h-12 items-center gap-5 border-t border-t-border bg-foreground px-5 py-1 text-text-foreground">
      ...
      <form className="flex h-full flex-[1] items-center gap-2">
        ...
        {/* SEND BUTTON */}
        <button className="hover:bg-primary-hover flex items-center justify-center rounded-full bg-primary p-2 text-white transition duration-300">
          <MdSend />
        </button>
      </form>
    </div>
